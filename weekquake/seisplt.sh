...
`echo ~/seismo/weekquake/dataprocess.py -m ../CMTSOLUTION -l 0 -L 3500 -f 0.02 -F 1 -q S -d 0.025 *.SAC`
...
#`~/seismo/weekquake/dataplot.py -a s -T -50/150/a50f10 -M 0.6c -G 59/92 -A 18/41 *.BHT`
